...
const projects = [
  {
    id: 1,
    title: "eAgilaApp",
    description: "Capstone project about a Cloud-based inventory management system with E-commerce for Agila Hardware and Construction Supplies  ",
